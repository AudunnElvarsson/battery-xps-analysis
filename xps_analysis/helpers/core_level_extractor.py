...
def extract_core_level(file_path):
    ...
    include C1s, O1s, F1s, Li1s, P2p, etc.
    ...
    -------
    str or None
        The extracted core level (e.g., 'C1s', 'O1s', 'F1s') or None if no
        valid core level pattern is found.
    ...
    if core_level_pattern.match(candidate):
        return candidate
